...
require VIEWS_PATH . '/commission_user/layouts/header.php';
?>
...
<section class="view-section active" id="viewCommission">
    ...
    <div class="fin-card" style="padding: 60px 24px; text-align: center; border-radius: 12px; background: #ffffff; border: 1px solid var(--border-color, #e2e8f0); margin-top: 12px;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 700; color: #0F172A; margin-bottom: 8px;">Commission Portal</h2>
        <p style="color: #64748B; font-size: 0.92rem; max-width: 480px; margin: 0 auto; line-height: 1.5;">
            Welcome to the Commission section. This page is currently set up for Commission Officer access.
        </p>
    </div>
</section>

<?php require VIEWS_PATH . '/commission_user/layouts/footer.php'; ?>
