<?php
/**
 * Header Layout Template - Report User Portal
 */
...
$role = $currentUser['role'] ?? 'report_user';
$userInitials = 'RU';
...
$displayRoleTitle = 'Reports Manager';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?= e($pageTitle ?? 'Weekly Reports - Finance Portal') ?></title>
    <!-- Google Fonts -->
    ...
    <div class="app-canvas">
        <div class="main-wrapper">
            ...
            <header class="top-navbar">
                <div class="nav-left">
                    <a href="<?= url('reports') ?>" class="header-brand">
                ...
                <!-- Top Navigation Links (Report User: ONLY Reports) -->
                <nav class="top-nav-links">
                    <a href="<?= url('reports') ?>" class="top-nav-item active" id="navReports">
                    ...
                    <div class="user-profile-dropdown" id="userProfileDropdown">
                        <button class="user-profile-widget user-profile-btn" id="userProfileBtn" aria-expanded="false" aria-haspopup="true">
                            ...
                            <div class="user-meta-text">
                                <span class="user-meta-name"><?= e($currentUser['full_name'] ?? 'Report User') ?></span>
